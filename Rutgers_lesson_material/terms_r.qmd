...
Some metadata standards used in ocean science include [EML](https://eml.ecoinformatics.org/), [ISO19115](https://www.fgdc.gov/metadata/iso-standards), and [Darwin Core](https://dwc.tdwg.org/).  
